...
static pair_t *
hashtable_find_pair(hashtable_t *hashtable, bucket_t *bucket, const void *key,
                    size_t hash)
{
  list_t *list;
  pair_t *pair;
...
static int
hashtable_do_del(hashtable_t *hashtable, const void *key, size_t hash)
{
  pair_t *pair;
  bucket_t *bucket;
  size_t index;
...
static void
hashtable_do_clear(hashtable_t *hashtable)
{
  list_t *list, *next;
  pair_t *pair;
...
hashtable_t *
hashtable_create(key_hash_fn hash_key, key_cmp_fn cmp_keys, free_fn free_key,
                 free_fn free_value)
{
  hashtable_t *hashtable = nc_alloc(sizeof(hashtable_t));
  if (!hashtable)
    return NULL;
...
int
hashtable_init(hashtable_t *hashtable, key_hash_fn hash_key,
...
void *
hashtable_iter_at(hashtable_t *hashtable, const void *key)
{
  pair_t *pair;
  size_t hash;
  bucket_t *bucket;
...
void
hashtable_iter_set(hashtable_t *hashtable, void *iter, void *value)
{
  pair_t *pair = list_to_pair((list_t *)iter);
